...
echo "Total number of people surveyed - " . $drinks->getCustomers() . ".\n";
echo "Approximately " . round($drinks->calculateEnergyDrinks(),) . " bought at least one energy drink.\n";
echo  round($drinks->calculateTCitrusDrinks()). " of those " . "prefer citrus flavored energy drinks.";
